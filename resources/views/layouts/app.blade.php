...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100">
        <div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center justify-start rtl:justify-end">
                            ...
                            <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                                <img src="{{ asset('images/login_logo.png') }}" class="h-14 w-50 mr-3"
                                    alt="Flowbite Logo" alt="">
                            </a>
                        </div>
                            ...
                            <div class="flex items-center ms-3">
                                ...
                                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                                    ...
                                    <div class="px-4 py-3" role="none">
                                        ...
                                        <p class="text-sm font-medium text-gray-900 truncate bg-slate-200 p-1 border rounded"
                                            role="none">
                                            Role: {{ auth()->user()->role }}
                                        </p>
                                    </div>
                    ...
                    <ul class="space-y-2 font-medium">
                        ...
                        <li>
                            <a href="{{ route('admin.leave') }}"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">Leave Type</span>
                            </a>
                        </li>
                        @endif
            ...
            <div class="pr-2 pl-2 sm:ml-64 mt-12">
